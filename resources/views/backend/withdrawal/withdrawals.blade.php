...
@section('withdrawal_active', 'active')
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-4">
                    <div class="card custom__card__px--medical shadow">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('withdrawal') }}" method="POST" enctype="multipart/form-data"
                ...
                <div class="col-sm-8">
                    <div class="card custom__card__px--medical shadow">
                        <div class="card-header">
                            <h3 class="card-title">Withdrawal Amounts</h3>
                        </div>
                        <div class="card-body px-0 pt-0">
                            <table class="table custom__table--two">
                                ...
                                <tbody>
                                    @php
                                        $no = $withdrawals->perPage() * ($withdrawals->currentPage() - 1) + 1;
                                    ...
                                    <tr>
                                        <td colspan="100">
                                            <div class="d-flex " style="justify-content: space-between;">
                                                <span>Showing <?= count($withdrawals) ?> of <?= $totalRows ?>
                                                    rows</span>
                                                <span><?php if ($withdrawals->hasPages()) {
                                                    echo $withdrawals->links('pagination::bootstrap-4');
                                                } ?>
                                                </span>
                                            </div>
                                        </td>
